...
<!-- Mirrored from quomodosoft.com/html/bankcohtml/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 24 Feb 2025 08:45:34 GMT -->
...
<body>
  <div class="body-bg">
    ...
    <div class="nftmax-smenu">
      <div class="logo">
        <a href="index.html">
          <img class="nftmax-logo__main" src="{{asset('admin/assets/images/logo/Logo.svg')}}" alt="logo">
      ...
      <div class="logo logo-dark ">
        <a href="index.html">
          <img class="nftmax-logo__main" src="{{asset('admin/assets/images/logo/Logo-dark.png')}}" alt="logo">

        </a>

        <div class="logo-two">
          <img src="{{asset('admin/assets/images/logo/logo-shape-dark.png')}}" alt="img">
        </div>
        <div class="nftmax__sicon close-icon">
          <span>
            <svg width="16" height="40" viewBox="0 0 16 40" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div class="admin-menu">
          ...
          <div class="menu-bar">
            <ul class="sidebar_nav">
              ...
              <li class="has-child menu-main   ">
                ...
                <ul>
                  <li>
                    <a href="index.html">Dashboard Default</a>
                  </li>
                  <li class="">
                    <a href="index_02.html">Dashboard Two</a>
                  </li>
                  <li class="">
                ...
                <a href="message.html">
                  <div class="has-child-main">
                    <div class="has-child-main-inner">
                      <div class="has-child-icon">
                        <span>
                          <svg width="16" height="18" viewBox="0 0 16 18" fill="none"
                            ...
                            <path class="svg-color-1" fill-rule="evenodd" clip-rule="evenodd"
                      ...
                      <span class="has-child-profile-1">
                      ...
                      <span class="has-child-profile-2">
                        <img src="{{asset('admin/assets/images/profile-2.png')}}" alt="profile">
                      </span>
                        ...
                        <span>
                          <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                            ...
                            <path
                              ...
                              class="svg-color-1" />
                            <circle cx="6.03784" cy="18" r="4.46166" class="svg-color-1" />
                            <path fill-rule="evenodd" clip-rule="evenodd"
                      ...
                      <div class="has-child-icon">
                        <span>
                          <svg width="14" height="18" viewBox="0 0 14 18" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <ellipse class="svg-color-1" cx="7" cy="14" rx="7" ry="4" />
                        ...
                        <span>
                          <svg width="18" height="21" viewBox="0 0 18 21" fill="none"
                            ...
                            <path fill-rule="evenodd" clip-rule="evenodd"
                              ...
                              class="svg-color-1"></path>
                            <circle cx="9" cy="14" r="1"></circle>
                            <circle cx="13" cy="14" r="1" class="path-2"></circle>
                            <circle cx="5" cy="14" r="1" class="path-2"></circle>
                          </svg>
                        </span>
                      </div>
                    ...
                    <div class="has-child-main-inner">
                      <div class="has-child-icon mt-1">
                        <span>
                          <svg width="14" height="18" viewBox="0 0 14 18" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <ellipse class="svg-color-1" cx="7" cy="14" rx="7" ry="4"></ellipse>
                    ...
                    <div class="has-child-main-inner">
                      <div class="has-child-icon">
                        <span>
                          <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <circle cx="10" cy="10" r="10" class="svg-color-1"></circle>
                            <path
        ...
        <div class="cashback">
          <div class="cashback-icon">
            <img src="{{asset('admin/assets/images/icon/cashback-icon.png')}}" alt="img">
          </div>
              ...
              <a href="#">Upgrade Now
                <span>
                  <svg width="12" height="8" viewBox="0 0 12 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path d="M8 6.66667L10.6667 4" stroke="white" stroke-width="1.5" stroke-linecap="round"
                      stroke-linejoin="round" />
                    <path d="M8 1.33325L10.6667 3.99992" stroke="white" stroke-width="1.5" stroke-linecap="round"
                      stroke-linejoin="round" />
                  </svg>
                </span>
              </a>
                  ...
                  <div class="header-search-img">
                    <span>
                      <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <circle cx="9.7859" cy="9.78614" r="8.23951" stroke-width="1.5" stroke-linecap="round"
                          stroke-linejoin="round" />
                        <path d="M15.5166 15.9448L18.747 19.1668" stroke-width="1.5" stroke-linecap="round"
                          stroke-linejoin="round" />
                      </svg>
                    </span>
                  </div>
              ...
              <div class="header-right">
                      ...
                      <li data-name="notification">
                        <a href="#" data-name="notification">
                          <span data-name="notification">
                            <svg data-name="notification" width="24" height="25" viewBox="0 0 24 25"
                              xmlns="http://www.w3.org/2000/svg">
                              <path
                            ...
                            <div class="notification">
                              <div class="notification-head">
                                ...
                                <div class="notification-icon">
                                  <a href="#">
                                    <span>
                                      <svg class="svg-two" width="20" height="20" viewBox="0 0 20 20" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                              ...
                              <div class="notification-item-main">
                                <div class="notification-item">
                                  <div class="notification-item-text">
                                    <p> <span>James Eusobio </span> send a new payment for <span>
                                        SEO writing
                                      </span> totaling <span class="color-green"> $199.00</span></p>
                              ...
                              <div class="notification-btm notification-btm-two ">
                                <div class="notification-btm-text">
                                  <h2> <span class="">
                                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path d="M7 12L12 17L22 7M2 12L7 17M12 12L17 7" stroke="#0CAF60"
                      ...
                      <li data-name="massage-drop">
                        <a href="#" data-name="massage-drop">
                          <span data-name="massage-drop">
                            <svg data-name="massage-drop" width="24" height="25" viewBox="0 0 24 25" fill="none"
                              xmlns="http://www.w3.org/2000/svg">
                              <path
                                ...
                                <div class="massage-item">
                                  <div class="massage-inner">
                                    <div class="massage-img">
                                      <img src="{{asset('admin/assets/images/massage-1.png')}}" alt="img">
                                      <div class="round"></div>
                                    </div>
                                  ...
                                  <div class="massage-inner">
                                    <div class="massage-img">
                                      <img src="{{asset('admin/assets/images/massage-2.png')}}" alt="img">
                                  ...
                                  <div class="massage-inner">
                                    <div class="massage-img">
                                      <img src="{{asset('admin/assets/images/massage-3.png')}}" alt="img">
                                      <div class="round "></div>
                                    </div>
                                    <div class="massage-item-text">
                    ...
                    <ul data-name="gift">
                      <li data-name="gift">
                        <a href="#" data-name="gift">
                          <span data-name="gift">
                            <svg data-name="gift" width="24" height="25" viewBox="0 0 24 25" fill="none"
                              xmlns="http://www.w3.org/2000/svg">
                              <path
                            ...
                            <div class="notification">
                              <div class="gift-item">
                                ...
                                <div class="gift-item-taitel-img">
                                  <img src="{{asset('admin/assets/images/Group.png')}}" alt="img">
                                </div>
                              </div>
                ...
                <div class="profile icon-dropdown" data-name="profile-drop">
                  ...
                  <div class="profile-img" data-name="profile-drop">
                    <img src="{{asset('admin/assets/images/profile.png')}}" alt="img" data-name="profile-drop">
                  </div>
                  <div class="profile-taitel" data-name="profile-taitel ">
                    <h3 data-name="profile-drop">
                      AJOY Sarker
                      <span data-name="profile-drop"><svg data-name="profile-drop" width="24" height="24"
            ...
            <div class="total-earnings">
              <div class="total-earnings-main">
                <div class="sub-earnings">
                  <div class="icon">
                    <img src="{{asset('admin/assets/images/icon/total.png')}}" alt="icon">
                  </div>
                  <div class="text">
                ...
                <div class="sub-earnings-user">
                  <img src="{{asset('admin/assets/images/icon/user.png')}}" alt="img">
                </div>
              </div>
          ...
          <div class="col-lg-4 col-md-6 col-responsive-padd-top-20px">
            <div class="total-earnings">
              <div class="total-earnings-main">
                <div class="sub-earnings">
                  <div class="icon">
                    <img src="{{asset('admin/assets/images/icon/total-1.png')}}" alt="icon">
                  </div>
                  <div class="text">
        ...
        <div class="row tabel-main-box">
              ...
              <div class="tabel-search-box-item">
                ...
                <div class="tabel-search-box-button">
                  <div class="tabel-search-box-button-img">
                    <img src="{{asset('admin/assets/images/icon/filter.svg')}}" alt="img">
                  </div>
                  <div class="dropdown">
              ...
              <div class="list-btn">
                <div class="dropdown">
                  <button class="btn dropdown-toggle" type="button" id="dropdownMenuButton2" data-bs-toggle="dropdown"
                    ...
                    <span class="btn-img">
                      <img src="{{asset('admin/assets/images/icon/chevron-down.png')}}" alt="img">
                    </span>
                  </button>
          ...
          <div class="col-lg-3 col-md-6 col-padding-0 col-pr-15px margin-top-20px">
            <div class="list-btn-item">
              ...
              <div class="list-btn">
                <div class="dropdown">
                  <button class="btn dropdown-toggle" type="button" id="dropdownMenuButton2-0" data-bs-toggle="dropdown"
                    aria-expanded="false">
                    > $1,000
                    ...
                    <span class="btn-img">
                      <svg width="19" height="20" viewBox="0 0 19 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                          ...
                          stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                        <path d="M13.6753 0.818726V4.81873" stroke-width="1.5" stroke-linecap="round"
                          stroke-linejoin="round" />
                        <path d="M5.67529 0.818726V4.81873" stroke-width="1.5" stroke-linecap="round"
                          stroke-linejoin="round" />
                        <path d="M1.67529 8.81873H17.6753" stroke-width="1.5" stroke-linecap="round"
                          stroke-linejoin="round" />
                        <path d="M8.67529 12.8187H9.67529" stroke-width="2" stroke-linecap="round"
                          stroke-linejoin="round" />
                        <path d="M9.67529 12.8187V15.8187" stroke-width="1.5" stroke-linecap="round"
                          stroke-linejoin="round" />
                      </svg>
                    </span>
                  </button>
            ...
            <div class="tabel-main">
              <table id="expendable-data-table" class="table display nowrap">
                    ...
                    <th>
                      ...
                      <span>
                        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path d="M11.332 2.31567V14.3157" stroke="#718096" stroke-width="1.5" stroke-linecap="round"
                            stroke-linejoin="round" />
                          <path d="M6.66602 12.3157L4.66602 14.3157L2.66602 12.3157" stroke="#718096" stroke-width="1.5"
                            stroke-linecap="round" stroke-linejoin="round" />
                          <path d="M4.66602 14.3157V2.31567" stroke="#718096" stroke-width="1.5" stroke-linecap="round"
                            stroke-linejoin="round" />
                          <path d="M13.332 4.31567L11.332 2.31567L9.33203 4.31567" stroke="#718096" stroke-width="1.5"
                            stroke-linecap="round" stroke-linejoin="round" />
                        </svg>
                      </span>
                    </th>
                ...
                <tbody>
                  <tr>
                    <td class="details-control">
                      <input class="form-check-input" type="checkbox" id="checkboxNoLabel-0" value="" aria-label="...">
                    </td>
                    <td>
                      <div class="tabel-item">
                        <div class="tabel-img">
                          <img src="{{asset('admin/assets/images/tabel-1.png')}}" alt="img">
                        </div>
                  ...
                  <tr>
                    <td class="details-control">
                      <input class="form-check-input" type="checkbox" id="checkboxNoLabel-001" value=""
                        aria-label="...">
                    </td>
                    <td>
                      <div class="tabel-item">
                        <div class="tabel-img">
                          <img src="{{asset('admin/assets/images/tabel-2.png')}}" alt="img">
                        </div>
                        <div class="tabel-text">
                          <p>Bessie Cooper</p>
                        </div>
                  ...
                  <tr>
                    <td class="details-control">
                      <input class="form-check-input" type="checkbox" id="checkboxNoLabel-11" value="" aria-label="...">
                    </td>
                    <td>
                      <div class="tabel-item">
                        <div class="tabel-img">
                          <img src="{{asset('admin/assets/images/tabel-3.png')}}" alt="img">
                        </div>
                        <div class="tabel-text">
                          <p>Dianne Russell</p>
                        </div>
            ...
            <div class="my-walet-item-box">
              <div class="my-walet-item-box-inner">
                ...
                <div class="my-walet-item-box-btn">
                  <div class="dropdown">
                    <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton1-05"
                      data-bs-toggle="dropdown" aria-expanded="false">
                      <svg width="18" height="4" viewBox="0 0 18 4" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                          d="M8 2C8 2.55228 8.44772 3 9 3C9.55228 3 10 2.55228 10 2C10 1.44772 9.55228 1 9 1C8.44772 1 8 1.44772 8 2Z"
                          stroke="#CBD5E0" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                        <path
              ...
              <div class="my-walet-item-box-img-slick">
                <div class="my-walet-item-box-img">
                  <img src="{{asset('admin/assets/images/card-1.svg')}}" class="w-100" alt="img">
                </div>
                <div class="my-walet-item-box-img">
                  <img src="{{asset('admin/assets/images/card-2.svg')}}" class="w-100" alt="img">
                </div>
                <div class="my-walet-item-box-img">
                  <img src="{{asset('admin/assets/images/card-3.svg')}}" class="w-100" alt="img">
                </div>
              </div>
              ...
              <div class="quick-transfr">
                ...
                <div class="quick-trandfr-btn">
                  <div class="dropdown">
                    <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton1-02"
                      data-bs-toggle="dropdown" aria-expanded="false">
                      <span class="one">
                        <span>
                          <svg width="26" height="16" viewBox="0 0 26 16" fill="none"
                            ...
                            <g clip-path="url(#clip0_1557_18621)">
                              <path fill-rule="evenodd" clip-rule="evenodd"
                                d="M9.3877 14.2687H16.3464V1.70776H9.3877V14.2687Z" fill="#FF5F00" />
                              <path fill-rule="evenodd" clip-rule="evenodd"
                      ...
                      <span class="two">
                        ...
                        <span class="btn-text-svg"><svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="btn-two">
                  ...
                  <div class="btn-main">
                    ...
                    <div class="btn-img">
                      <img src="{{asset('admin/assets/images/recipient.png')}}" alt="img">
                    </div>
                  </div>
                </div>
          ...
          <div class="team-chat">
            <div class="team-chat-head">
              <div class="team-chat-head-item">
                ...
                <div class="left">
                  <img src="{{asset('admin/assets/images/member.png')}}" alt="img">
                  <button class="btn" type="button">
                    <span>
                      <img src="{{asset('admin/assets/images/icon/plus.png')}}" alt="img">
                    </span>
                  </button>
                </div>
              </div>
            ...
            <div class="team-chat-item">
              <div class="team-chat-item-inner">
                <div class="team-chat-item-inner-img">
                  <img src="{{asset('admin/assets/images/user-1.png')}}" alt="img">
                </div>
              ...
              <div class="team-chat-item-inner">
                ...
                <div class="team-chat-item-inner-text">
                  <img src="{{asset('admin/assets/images/mp3.png')}}" class="img-fluid" alt="img">
                  <h6>10:00 PM</h6>
                </div>
              </div>
              <div class="team-chat-item-inner">
...
<!-- Mirrored from quomodosoft.com/html/bankcohtml/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 24 Feb 2025 08:45:39 GMT -->
</html>
...
<section class="slider-hero">
    <div class="slider-home-1 owl-carousel owl-theme">
       <div class="hero-section item" style="background-image: url({{ asset('giaodien') }}/assets/img/hero-1.jpg)">
          <div class="container">
       ...
       <div class="hero-section item" style="background-image: url({{ asset('giaodien') }}/assets/img/hero-2.jpg)">
          <div class="container">
             <div class="row align-items-end">
                <div class="col-xl-6">
                   <div class="featured-area">
       ...
       <div class="hero-section item" style="background-image: url({{ asset('giaodien') }}/assets/img/hero-3.jpg)">
          <div class="container">
             <div class="row align-items-end">
                <div class="col-xl-6">
                   <div class="featured-area">
       ...
       <div class="hero-section item" style="background-image: url({{ asset('giaodien') }}/assets/img/hero-4.jpg)">
          <div class="container">
             <div class="row align-items-end">
                <div class="col-xl-6">
                   <div class="featured-area">
    ...
    <div class="weekly-special">
                  ...
                  <img alt="Pizza" src="{{ asset('giaodien') }}/assets/img/pizze-img.png">
               </div>
</section>
<section class="gap">
   <div class="container">
         ...
         <div class="col-xl-6">
            <div class="about-text">
               ...
               <div class="mt-4 d-flex align-items-center">
                  <img alt="girl" src="{{ asset('giaodien') }}/assets/img/girl.jpg">
                  <div>
      ...
      <div class="row mt-5">
         <div class="col-xl-4 col-lg-6">
            <div class="restaurant-card">
               <img alt="Restaurant-img" class="w-100" src="{{ asset('giaodien') }}/assets/img/restaurant.jpg">
         ...
         <div class="col-xl-4 col-lg-6">
            <div class="restaurant-card coctail">
               <img alt="Restaurant-img" class="w-100" src="{{ asset('giaodien') }}/assets/img/restaurant-2.jpg">
               <div class="restaurant-span">
         ...
         <div class="col-xl-4 col-lg-6">
            <div class="restaurant-card">
               <img alt="Restaurant-img" class="w-100" src="{{ asset('giaodien') }}/assets/img/restaurant-3.jpg">
               <div class="restaurant-span">
...
<section class="section-discover-menu">
   <div class="container">
      ...
      <svg enable-background="new 0 0 512 512" height="512" viewBox="0 0 512 512" width="512" xmlns="http://www.w3.org/2000/svg"><g><path d="m457.49 296c-31.37 0-47.77-16.28-60.95-29.36-12.07-11.98-20.8-20.64-39.8-20.64-5.87 0-10.76.82-15.08 2.32 4.559 50.122-35.161 93.68-85.66 93.68-50.517 0-90.216-43.579-85.66-93.67-4.32-1.5-9.21-2.33-15.09-2.33-19 0-27.73 8.66-39.8 20.65-13.18 13.07-29.57 29.35-60.94 29.35-22.45 0-38.345-7.995-53.91-22.54 8.959 133.461 119.991 238.54 255.4 238.54 135.312 0 246.455-105.024 255.4-238.53-15.542 14.491-31.453 22.53-53.91 22.53zm-64.29 21c6.64-4.94 16.04-3.57 20.99 3.08l11.01 14.79c4.95 6.64 3.57 16.04-3.07 20.99-6.613 4.917-16.019 3.616-20.99-3.08l-11.02-14.79c-4.94-6.64-3.57-16.04 3.08-20.99zm-94.73 79.49 16.85-6.71c7.7-3.06 16.42.69 19.49 8.39 3.06 7.7-.7 16.42-8.39 19.48-16.271 6.16-17.659 7.78-22.4 7.78-16.46 0-20.846-22.861-5.55-28.94zm-133.06-28.37c8.09-1.8 16.1 3.3 17.89 11.39l4 18c1.8 8.09-3.3 16.1-11.38 17.9-8.253 1.802-16.134-3.424-17.9-11.39l-4-18c-1.8-8.09 3.3-16.1 11.39-17.9zm-72.4-45.6 17-7.16c7.63-3.21 16.43.37 19.64 8.01 3.22 7.63-.37 16.43-8 19.64-16.247 6.485-17.765 8.33-22.81 8.33-16.299 0-20.857-22.498-5.83-28.82z"/><path d="m54.51 266c19 0 27.73-8.66 39.8-20.65 13.18-13.07 29.57-29.35 60.94-29.35 8.73 0 16.3 1.26 22.96 3.36 30.977-65.527 124.413-65.93 155.58 0 6.66-2.1 14.23-3.36 22.95-3.36 31.36 0 47.76 16.27 60.94 29.35 12.07 11.99 20.8 20.65 39.81 20.65 26.307 0 33.867-17.424 53.47-33.27-11.636-130.11-120.941-232.73-254.96-232.73-133.766 0-243.326 102.414-254.96 232.75 19.603 15.79 27.1 33.25 53.47 33.25zm65.01-74.6c-4.58 0-9.1-2.09-12.05-6.05l-11.01-14.79c-4.94-6.64-3.57-16.04 3.08-20.99 6.64-4.94 16.04-3.57 20.99 3.08l11.01 14.79c7.416 9.968.133 23.96-12.02 23.96zm103.67-82.46c-16.053 6.078-17.641 7.78-22.39 7.78-5.97 0-11.6-3.58-13.94-9.46-3.07-7.7.69-16.42 8.39-19.48l16.85-6.71c7.7-3.06 16.42.69 19.48 8.39 3.07 7.69-.69 16.42-8.39 19.48zm116.4 29.7c-1.1.25-2.19.36-3.27.36-6.88 0-13.07-4.75-14.63-11.75l-4-18c-1.8-8.08 3.3-16.1 11.39-17.89 8.09-1.8 16.1 3.3 17.9 11.39l4 18c1.79 8.08-3.31 16.1-11.39 17.89zm99.54 41.38c-.65 7.83-7.21 13.75-14.93 13.75-.42 0-.84-.02-1.27-.05l-18.37-1.54c-8.26-.69-14.39-7.95-13.69-16.2.69-8.26 7.94-14.39 16.2-13.7l18.37 1.54c8.26.69 14.39 7.95 13.69 16.2z"/></g></svg>
         ...
         Coffee</button>
          <button class="nav-link" id="v-pills-pizza-tab" data-bs-toggle="pill" data-bs-target="#v-pills-pizza" type="button" role="tab" aria-controls="v-pills-pizza" aria-selected="false"><svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
        ...
        <div class="tab-content" id="v-pills-tabContent">
            ...
            <div class="row align-items-center discover-menu">
               <div class="col-xl-6">
                  <div class="discover-img">
                     <img alt="discover" src="{{ asset('giaodien') }}/assets/img/discover-1.png">
                  </div>
               </div>
               <div class="col-xl-5">
                  <div class="discover">
          ...
          <div class="tab-pane fade" id="v-pills-profile" role="tabpanel" aria-labelledby="v-pills-profile-tab">
            <div class="row align-items-center discover-menu">
               <div class="col-xl-6">
                  <div class="discover-img">
                     <img alt="discover" src="{{ asset('giaodien') }}/assets/img/discover-2.png">
                  </div>
               </div>
               <div class="col-xl-5">
                  <div class="discover">
          ...
          <div class="tab-pane fade" id="v-pills-coffee" role="tabpanel" aria-labelledby="v-pills-coffee-tab">
            <div class="row align-items-center discover-menu">
               <div class="col-xl-6">
                  <div class="discover-img">
                     <img alt="discover" src="{{ asset('giaodien') }}/assets/img/discover-3.png">
                  </div>
               </div>
               <div class="col-xl-5">
                  <div class="discover">
          ...
          <div class="tab-pane fade" id="v-pills-pizza" role="tabpanel" aria-labelledby="v-pills-pizza-tab">
            <div class="row align-items-center discover-menu">
               <div class="col-xl-6">
                  <div class="discover-img">
                     <img alt="discover" src="{{ asset('giaodien') }}/assets/img/discover-8.png">
                  </div>
               </div>
               <div class="col-xl-5">
                  <div class="discover">
          ...
          <div class="tab-pane fade" id="v-pills-burger" role="tabpanel" aria-labelledby="v-pills-burger-tab">
            <div class="row align-items-center discover-menu">
               <div class="col-xl-6">
                  <div class="discover-img">
                     <img alt="discover" src="{{ asset('giaodien') }}/assets/img/discover-7.png">
                  </div>
               </div>
               <div class="col-xl-5">
                  <div class="discover">
...
<section class="gap">
   <div class="container">
      <div class="row">
         <div class="col-lg-6">
            <div class="bbq" style="background-image: url({{ asset('giaodien') }}/assets/img/bbq.jpg)">
               <h2>Steaks & BBQ</h2>
         ...
         <div class="col-lg-6">
            <div class="bbq mb-0" style="background-image: url({{ asset('giaodien') }}/assets/img/bbq-1.jpg)">
               <h2>Cocktails</h2>
               <p>canonical classics to obscure <br> tiki drinks</p>
               <div class="bbr-price">
                  <div>
...
<section>
   <div class="container">
      <div style="background-image: url({{ asset('giaodien') }}/assets/img/patron.jpg)" class="reserve-table">
         <div class="row">
            <div class="col-xl-4">
      ...
      <div class="row dishes owl-carousel owl-theme">
         <div class="item col-xl-12">
            <div class="featured-dishes">
               <div class="featured-dishes-img">
                  <img alt="featured-dishes" src="{{ asset('giaodien') }}/assets/img/featured-dishes-1.png">
               </div>
               <ul class="star">
                  <li><i class="fa-solid fa-star"></i></li>
                  <li><i class="fa-solid fa-star"></i></li>
         ...
         <div class="item col-xl-12">
            <div class="featured-dishes">
               ...
               <div class="featured-dishes-img">
                  <img alt="featured-dishes" src="{{ asset('giaodien') }}/assets/img/featured-dishes-2.png">
               </div>
               <ul class="star">
                  <li><i class="fa-solid fa-star"></i></li>
                  <li><i class="fa-solid fa-star"></i></li>
               ...
               <a href="product-details.html"><h5>Banana Leaves</h5></a>
               <div class="d-flex">
                  <p><span>$</span>10.85</p>
                  <del>$14.5</del>
               </div>
         ...
         <div class="item col-xl-12">
            <div class="featured-dishes">
               <div class="featured-dishes-img">
                  <img alt="featured-dishes" src="{{ asset('giaodien') }}/assets/img/featured-dishes-3.png">
               </div>
               <ul class="star">
                  <li><i class="fa-solid fa-star"></i></li>
                  <li><i class="fa-solid fa-star"></i></li>
      ...
      <div class="row">
         <div class="col-xl-6">
            ...
            <div class="bratlee-slider owl-carousel owl-theme">
               <div class="bratlee-hamint item">
                  ...
                  <img alt="quote" class="quote" src="{{ asset('giaodien') }}/assets/img/quote.png">
               </div>
               <div class="bratlee-hamint item">
                  <p>A good restaurant is like a vacation; it transports you, and it becomes a lot more than just about the food. All great deeds and all great thoughts</p>
                  <div class="d-flex align-items-center mt-4">
         ...
         <div class="col-xl-6">
            <div class="bratlee-img">
               <img alt="bratlee-hamin2" class="bratlee-hamint-2" src="{{ asset('giaodien') }}/assets/img/bratlee-hamint-2.jpg">
               <img alt="bratlee-hamint" class="bratlee-hamint-1" src="{{ asset('giaodien') }}/assets/img/bratlee-hamint-1.jpg">
               <img alt="bratlee-hamin3" class="bratlee-hamint-3" src="{{ asset('giaodien') }}/assets/img/bratlee-hamint-3.jpg">
            </div>
         </div>
      </div>
   </div>
...
<section class="gap no-top">
   <div class="container">
      ...
      <div class="row">
         <div class="col-xl-4 col-lg-6">
            <div class="chef">
               <img alt="cook chef" src="{{ asset('giaodien') }}/assets/img/chef-1.png">
               <div class="chef-text">
                  <div>
                     ...
                     <img alt="sine" src="{{ asset('giaodien') }}/assets/img/sine.png">
                  </div>
               </div>
            </div>
         </div>
         <div class="col-xl-4 col-lg-6">
            <div class="chef">
               <img alt="cook chef" src="{{ asset('giaodien') }}/assets/img/chef-2.png">
               <div class="chef-text">
                  <div>
         ...
         <div class="col-xl-4 col-lg-6">
            <div class="chef mb-0">
               <img alt="cook chef" src="{{ asset('giaodien') }}/assets/img/chef-3.png">
               <div class="chef-text">
                  <div>
                     <span>Dessert specialist</span>
      ...
      <div class="row">
         <div class="col-xl-6">
            ...
            <ul class="higher-reach">
               <li><div class="bol"></div>Higher Reach - Minimal Effort</li>
               <li><div class="bol"></div>Showcase your Brand</li>
               <li><div class="bol"></div>Exclusive offers & discounts</li>
            </ul>
         ...
         <div class="col-xl-6">
            <div class="manage-your-img">
               <img alt="manage-your" src="{{ asset('giaodien') }}/assets/img/manage-your.png">
            </div>
         </div>
      </div>
   </div>
      ...
      <div class="row">
         <div class="col-xl-6">
            <div class="recent-news">
               <img alt="recent-news" src="{{ asset('giaodien') }}/assets/img/recent-news-1.jpg">
               <div>
                  <a href="#"><span>29 December, 2023</span></a>
                  <a href="blog-details.html"><h3>Table restaurant located in on Bank Street</h3></a>
                  <div class="d-flex align-items-center"><img alt="img" class="me-3" src="{{ asset('giaodien') }}/assets/img/man.jpg"><h6>by Thomas Walimes</h6></div>
               </div>
            </div>
         </div>
         <div class="col-xl-6">
            <div class="recent-news">
               <img alt="recent-news" src="{{ asset('giaodien') }}/assets/img/recent-news-2.jpg">
               <div>
                  <a href="#"><span>29 December, 2023</span></a>
...
<div class="gap no-top">
   <div style="background-image: url({{ asset('giaodien') }}/assets/img/follow.jpg)" class="follow">
